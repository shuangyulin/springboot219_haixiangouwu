...
public class HaixianOrderView extends HaixianOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String haixianOrderValue;
		/**
		* 支付类型的值
		*/
		private String haixianOrderPaymentValue;
	...
	public HaixianOrderView() {

	}

	public HaixianOrderView(HaixianOrderEntity haixianOrderEntity) {
		try {
			BeanUtils.copyProperties(this, haixianOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getHaixianOrderValue() {
				return haixianOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setHaixianOrderValue(String haixianOrderValue) {
				this.haixianOrderValue = haixianOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getHaixianOrderPaymentValue() {
				return haixianOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setHaixianOrderPaymentValue(String haixianOrderPaymentValue) {
				this.haixianOrderPaymentValue = haixianOrderPaymentValue;
			}

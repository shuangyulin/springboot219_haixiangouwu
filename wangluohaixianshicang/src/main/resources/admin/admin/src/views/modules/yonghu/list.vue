		...
		<div v-if="showFlag">
				...
				<el-row class="ad"
					...
					<el-form-item>
						...
						<a style="text-decoration:none" class="el-button el-button--success"
							v-if="isAuth('yonghu','导入导出')" icon="el-icon-download"
							href="http://localhost:8080/wangluohaixianshicang/upload/yonghuMuBan.xls">批量导入用户数据模板</a>
						&nbsp;
						<el-upload v-if="isAuth('yonghu','导入导出')" style="display: inline-block"
							action="wangluohaixianshicang/file/upload" :on-success="yonghuUploadSuccess"
							:on-error="yonghuUploadError" :show-file-list=false>
							<el-button v-if="isAuth('yonghu','导入导出')" type="success" icon="el-icon-upload2">批量导入用户数据
							</el-button>
						</el-upload>
						&nbsp;
						<!-- 导出excel -->
			...
			<div class="table-content">
				<el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yonghuPhone"
						header-align="center" label="用户手机号">
						<template slot-scope="scope">
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="sexTypes"
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yonghuEmail"
						header-align="center" label="电子邮箱">
						<template slot-scope="scope">
							{{scope.row.yonghuEmail}}
						</template>
					</el-table-column>

					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="newMoney"
						header-align="center" label="余额">
						<template slot-scope="scope">
							{{scope.row.newMoney}}
						</template>
					</el-table-column>
